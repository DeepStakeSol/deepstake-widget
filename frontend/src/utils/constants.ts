...
export const PRIORITY_FEE_BUFFER_LAMPORTS = BigInt(1_000_000);
export const UI_DECIMALS = 6n;
export const UI_SCALE = BigInt(10n ** UI_DECIMALS);
...
export const STAKE_PROGRAM = {
  ...
  STAKE_ACCOUNT_RENT_LAMPORTS: 2_500_000,
