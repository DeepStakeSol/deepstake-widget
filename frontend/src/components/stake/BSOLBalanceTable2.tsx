    ...
    <>
      <div className="stake-screen">
        <div className="stake-container">
          ...
          <p className="stake-epoch-note">
            The data is updated once per epoch. If you have performed an action, it'll be displayed
            here later.
          </p>
            ...
            {isLoadingData ? (
              ...
              <div className="stakes-table-container">
                {shouldShowTable ? (
                    ...
                    <tbody>
                      ...
                      {appliedStakes.map((stake, index) => (
                        <tr
                          key={stake.voteAcc}
                          className={
                            index % 2 === 0 ? 'stakes-table-row-even' : 'stakes-table-row-odd'
                          }
                        >
                      ...
                      {showPendingRow && (
                        ...
                        >
                          ...
                          <td className="stakes-table-cell stakes-table-cell-right other-pendings">
                            {formatAmount(pendingDifference)} SOL
                          </td>
                        </tr>
                      )}
                  ...
                  <div className="balance-container">
                    <div className="balance-content">
                      <span className="balance-value">{formatAmount(bSOLBalance)}</span>
                      <span className="balance-label">bSOL</span>
                    </div>
                  </div>
                )}
          ...
          <div className="stake-empty">
            {validatorName && appliedStakes.length === 0 && (
              <p className="delegated-text">
                Delegated on <strong>{validatorName}</strong> Validator.
              </p>
            )}
