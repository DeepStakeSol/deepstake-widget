...
import { recordLogoResponse } from "@/utils/observability/metrics";
import { getValidatorLogo } from "@/utils/validatorProfile/service";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    operationalLog("error", "validator_logo_aggregation_failed", {
      network,
